...
ourmailsender = MailSender('ttkien1503@gmail.com', 'fpge mxhq noqc fudm ', ('smtp.gmail.com', 587))
...
html = """Hello John, <br>
            ...
            <b>Adam</b>"""
ourmailsender.set_message(plaintext, "This is a test", "Tran Trung Kien", html, "example.txt", "example.txt")
...
ourmailsender.set_recipients(['tran.trung.kien@sun-asterisk.com'])
